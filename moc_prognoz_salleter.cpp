...
QT_MOC_LITERAL(3, 23, 35) // "QMap<QString,QList<data_salle..."

    },
    "prognoz_salleter\0data\0\0"
    "QMap<QString,QList<data_salleter> >"
};
...
void prognoz_salleter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        prognoz_salleter *_t = static_cast<prognoz_salleter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->data((*reinterpret_cast< QMap<QString,QList<data_salleter> >(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (prognoz_salleter::*_t)(QMap<QString,QList<data_salleter>> );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&prognoz_salleter::data)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void prognoz_salleter::data(QMap<QString,QList<data_salleter>> _t1)
{
